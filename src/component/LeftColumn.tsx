...
function LeftColumn() {
  ...
  return (
    <StyledLeftColumn>
      <InputBox tag="Bill" svg={svgPathArr[0]}/>
      ...
      <InputBox tag="People" svg={svgPathArr[1]}/>
    </StyledLeftColumn>
  );
}
